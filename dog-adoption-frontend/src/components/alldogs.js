...
//         <div className="dog-preview-list-item">
...
function Alldogs(props) {
  return <section className='dog-cards-wrapper'>
  ...
  //     </Link>
  //     {props.map((dog) =>
  //       <img alt={dog.dogName} src={require(dog.image)}/>,
  //     <div className="dog-preview-description-wrapper">
  //       <div className="subtitle-wrapper">
  //         <p className="text-strong">{dog.age}</p>
  //         <p> {dog.dogName}</p>
  //       </div>
